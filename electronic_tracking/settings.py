"""
Django settings for electronic_tracking project.
...
SECRET_KEY = 'django-insecure-y$sb*hndx$eyq6r7j@aw-3ckx24!otw)ftqdnw&18zo4vf@-ji'
...
WSGI_APPLICATION = 'electronic_tracking.wsgi.application'
