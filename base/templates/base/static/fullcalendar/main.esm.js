...
function isInteractionPropsValid(state, calendar, dateSpanMeta, filterConfig) {
    ...
    var otherEventStore = excludeInstances(state.eventStore, interaction.affectedEvents.instances); // exclude the batch events. TODO: exclude defs too?
    ...
    for (var subjectInstanceId in subjectInstances) {
        ...
        for (var otherInstanceId in otherInstances) {
            ...
            if (rangesIntersect(subjectRange, otherInstance.range)) {
                ...
                // consider the other event's overlap. only do this if the batch event is a "real" event
